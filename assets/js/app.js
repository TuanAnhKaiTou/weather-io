      ...
      card.innerHTML = `
        ...
        module.aqiText[aqi].message
          ...
          <div class="card card-sm highlight-card two">
            ...
            <div class="card-list">
              <div class="card-item">
                <div class="m-icon">clear_day</div>
                <div>
              ...
              <div class="card-item">
                <div class="m-icon">clear_night</div>
                <div>
          ...
          <div class="card card-sm highlight-card">
            ...
            <div class="wrapper">
              <div class="m-icon">humidity_percentage</div>
          ...
          <div class="card card-sm highlight-card">
            ...
            <div class="wrapper">
              <div class="m-icon">visibility</div>
              <p class="title-1">${visibility.toLocaleString()}<sub>km</sub></p>
            </div>
          </div>
          ...
          <div class="card card-sm highlight-card">
            ...
            <div class="wrapper">
              <div class="m-icon">thermostat</div>
